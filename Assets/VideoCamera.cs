...
{  
    ...
    {  
        ...
        {  
            ...
            GUI.DrawTexture(new Rect(Screen.width/2-150,Screen.height/2-190,280,200), _webCamTexture);   
        }  
    ...
    {  
        ...
        {  
            ...
            _webCamTexture=new WebCamTexture(deviceName,300,300,12);  
            _webCamTexture.Play();  
        }  
    }  
...
//      File.WriteAllBytes(Application.dataPath+"/Photoes/"+Time.time+".jpg",byt);  
    ...
    {  
        ...
        {  
            yield return new WaitForEndOfFrame();  
            Texture2D texture = new Texture2D(400, 300, TextureFormat.RGB24, true);  
