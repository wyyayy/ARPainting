...
/// Fix the problem when use il2cpp/AOT. 
/// Without these declarations, The throw the default cotor not found exception.
/// Note: If you need use custom enum, please manually add the EnumConverter like this.
